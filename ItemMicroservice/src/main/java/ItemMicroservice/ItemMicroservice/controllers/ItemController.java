package ItemMicroservice.ItemMicroservice.controllers;

import ItemMicroservice.ItemMicroservice.models.Item;
import ItemMicroservice.ItemMicroservice.services.ItemService;
...
public class ItemController {
    ...
    public ResponseEntity<?> insertNewItem(@RequestBody Item item) {
        try {
            Item newItem = itemService.createNewItem(item); // note: I changed the service method name
